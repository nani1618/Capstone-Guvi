...
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR | By Vedavrath Pathi",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Vedavrath Pathi*!"""})
...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://th.bing.com/th/id/R.f4af00c61f60e4ca9487f7ad536dd0e6?rik=%2bfCpX3u0MSthRQ&riu=http%3a%2f%2fwallpapercave.com%2fwp%2f92r6xWU.jpg&ehk=3xXbcuUb0DBoXcr2YXGG04YDZfB7R3L0ASo0iAZahWE%3d&risl=&pid=ImgRaw&r=0");
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            with open(os.path.join("uploaded_images",uploaded_card.name), "wb") as f:
        ...
        with col2:
            ...
            with st.spinner("Please wait processing image..."):
                ...
                saved_img = os.getcwd()+ "\\" + "uploaded_images"+ "\\"+ uploaded_card.name
