...
st.set_page_config(page_title="AirBnb-Analysis by Vedavrath Pathi", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"Vedavrath Pathi"}')
    mail = (f'{"Mail :"}  {"vedavrath.pathi@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        "Youtube": "https://youtu.be/zSHhbbkMGVM",
        "GITHUB": "https://github.com/VedavrathPathi/GUVI-CAPSTONE-PROJECTS",
        "LINKEDIN": "https://www.linkedin.com/in/vedavrathpathi/"}
